...
Singapore, Dec 2024 – Nov 2025

- Designed and developed scalable APIs for a digital banking platform handling high-volume, real-time transaction processing.
- Enhanced and integrated legacy EJB components to deliver new features while maintaining compatibility within the enterprise architecture.
- Orchestrated and managed batch workflows across multiple environments, collaborating with cross-functional teams to support deployments and operational processes.
- Established standardized API integration testing practices, improving cross-service reliability and reducing downstream integration defects.
- Supported weekly system integration testing activities in UAT environments to ensure smooth release validation.
- Contributed to production stability and BAU support by monitoring live systems and proactively resolving incidents.

### Senior Software Developer - Yoma Bank
Yangon, Myanmar, Jan 2023 – Mar 2024 

- Designed and developed scalable microservices to deliver business banking capabilities within a digital banking platform.
- Implemented reactive, non-blocking APIs to optimize system utilization under high-volume transaction workloads.
- Integrated third-party biller APIs into the platform, enabling end-to-end transaction orchestration.
- Mentored three junior developers, reviewing code to ensure alignment with system requirements and coding standards.
- Supported integration testing and deployment processes in collaboration with QA and DevOps teams.

### Full stack Developer - Myanmar Information Technology
Yangon, Myanmar Aug 2019 – Aug 2021 

- Developed digital solutions including eCommerce platforms, asset management systems, and POS applications.
- Gathered and analyzed requirements from vendors and stakeholders, translating business needs into system designs and technical solutions.
- Collaborated with cross-functional teams, including mobile developers, to coordinate API integrations and support feature implementation.
- Managed software deployments and resolved production issues to ensure system stability.
...
### Soft Skill 
Collaboration, Adaptability, Passion, Problem-solving 
